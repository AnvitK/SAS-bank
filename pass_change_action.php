...
<body>
    <div class="flex-container">
        <div class="flex-item">
            ...
            <?php
            if ($err_no == 0) { ?>
                <p id="info"><?php echo " Password successfully changed !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 1) { ?>
                <p id="info"><?php echo "Old Password is incorrect !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 2) { ?>
                <p id="info"><?php echo "Passwords do not match !\n"; ?></p>
            <?php } ?>

            <?php
            if ($err_no == 3) { ?>
                <p id="info"><?php echo "Old & new Passwords are same !\n"; ?></p>
            <?php } ?>
        </div>
